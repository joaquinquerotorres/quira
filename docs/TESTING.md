...
| tests/Service/ | StripeCheckoutSessionHandlerTest, GeminiServiceTest (`diagnose`, campos de seguridad y payload hacia la API de Gemini), PricingClampServiceTest (post-diagnose clamp A+C), PredictMediaFetcherTest (anti-SSRF + descarga a Data URL) |
